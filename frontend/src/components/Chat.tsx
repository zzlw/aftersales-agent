...
/* lucide 已移除品牌图标，内联 GitHub 官方 mark（尺寸对齐 lucide 默认 16px） */
      ...
      <header className="flex h-16 shrink-0 items-center justify-between gap-3 border-b border-border bg-card px-4 sm:px-6">
        ...
        <div className="flex shrink-0 items-center gap-1.5">
          ...
          <Button
            ...
            variant="ghost"
            size="icon"
            className="size-8 text-muted-foreground hover:text-foreground active:scale-[0.98]"
          >
            <a
              href="https://github.com/zzlw/aftersales-agent"
              target="_blank"
